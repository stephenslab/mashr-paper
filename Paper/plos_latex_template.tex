...
%\section*{Results}
%
%Considering a scatterplot of our results against the original summary statistics, the ability of Matrix ASH to selectively shrink only 
%
% \begin{figure}
...
%
% \begin{figure}
%\includegraphics[width=5cm]{differentshrink}
