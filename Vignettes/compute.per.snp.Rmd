...
covmat=compute.covmat(b.gp.hat,se.gp.hat,Q=5,t.stat,lambda,P=2,A="simulation",factor.mat=factors,bma=TRUE)
...
cor(as.vector(as.matrix(post.means)),as.vector(as.matrix(b.truth.test[1:100,])))
