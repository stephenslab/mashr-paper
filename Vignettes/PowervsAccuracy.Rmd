...
# mash.sigs=sig_func(beta,lfsr.mash,thresh=0.01)
...
plot(0.05,sum(sign.test.mash>0&lfsr.mash<0.05),col="blue",ylim=c(0,15000),xlim=c(0.01,0.10),pch=2,ylab="NumberofTrueAssociationsCaptured",xlab="LFSRThreshold")
...
legend("bottom",legend=c("MASH","BMALite","ASH"),pch=c(2,1,3),col=c("blue","red","green"))
title("Sign Correct vs Significance (LFSR) Threshold,Sharing")
```
