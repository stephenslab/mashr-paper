...
```{r readindata}
library("mvtnorm")
data=readRDS("../simdata/simdata_tspec.rds")
...
A="yourfavoritename"
factor.mat=as.matrix(read.table("../simdata/tri_sim_spect_F.out"))
lambda.mat=as.matrix(read.table("../simdata/tri_sim_spect_lambda.out"))
...
A="yourfavoritename"
pis=readRDS(paste0("../simdata/pis",A,".rds"))$pihat
...
A="yourfavoritename"
pis=readRDS(paste0("../simdata/pis",A,".rds"))$pihat
covmat=readRDS(paste0("../simdata/covmat",A,".rds"))
...
post.means=as.matrix(read.table(paste0("../simdata/",A, "posterior.means.txt"))[,-1])
...
mash.means=as.matrix(read.table(paste0("../simdata/",A, "posterior.means.txt"))[,-1])
univariate.ash.pm=read.table("../simdata/uniashpm.txt")
