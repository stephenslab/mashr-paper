...
covmat=compute.covmat(b.gp.hat = t,sebetahat = v.j,Q =5, t.stat=max.t,lambda.mat=lambda.mat,P=3,A="testim_tspec_new", factor.mat = factor.mat,bma = TRUE)##Note that here, we perform our inference including the BMA configs.
```
...
compute.hm.train(train.b = t[1:20000,],se.train = v.j[1:20000,],covmat = covmat,A="testtissuespec")
...
![alt text](Figures/scatterplot.fittedtspec.png) 
![alt text](Figures/scatterplot.truthtspec.png)
![alt text](Figures/scatterplot.TRUTHashtspec.png)
