...
covdat = factor_sim(n=1000,K=10,betasd=3,esd=0.3,d=5)
...
newdat = factor_sim(n=10000,K=10,betasd=1,esd=0.3,d=5)
...
lapply(seq(1:R),function(r){plot(b.truth.test[1:10,r],post.means[,r])})
