...
sim_data = factor_sim_new(J = 20000) 
saveRDS(sim_data,"newsimdata.rds")
````

Here, I load my previously simulated data:

```{r,echo=T}
sim_data = readRDS("newsimdata.rds")
t         = sim_data$tstat
...
``````{r generate_covmatswithbovy,eval=FALSE}
...
*What does this last chunk do? It seems like a nice plot, but I'm not sure what
it is showing. --Peter*
