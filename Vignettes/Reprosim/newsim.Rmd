...
This requires the package be installed.
...
If you wanted to compute the denoised estimates using Extreme Deconvolution, you would need the Extreme Deconvolution package from Bovy et al as well, using the following package:
