...
compute.mixture.dist(b.gp.hat,J=5,se.gp.hat,covmat,A="fiveeighteen")
compute.total.quant(A="fiveeighteen",J=5)
checkfunc(1,b.gp.hat,se.gp.hat,A="fiveeighteen",1180)
